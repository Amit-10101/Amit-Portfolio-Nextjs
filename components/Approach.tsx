	...
	return (
		...
		>
			...
			<div className="relative z-20">
				...
				<h2 className="text-sm opacity-0 group-hover/canvas-card:opacity-100 relative z-10 mt-4  font-bold group-hover/canvas-card:text-white group-hover/canvas-card:-translate-y-2 transition duration-200 text-center text-[#e4ecff]">
					{description}
				</h2>
			</div>
		</div>
